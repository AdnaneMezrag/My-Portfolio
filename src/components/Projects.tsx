...
function ProjectCard({ title, description, image, imageUrl, technologies, liveUrl, githubUrl, featured }: ProjectItem) {
  return (
        ...
        <div className="flex space-x-3 mt-auto">
          {liveUrl && (
            <a
              ...
              className="flex items-center space-x-1 bg-blue-600 hover:bg-blue-700 text-white text-sm px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg transform"
            >
          ...
          {githubUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-1 border border-gray-300 hover:bg-gray-50 text-gray-700 text-sm px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105 hover:border-gray-400 transform"
            >
